const johto = {
    descriptions: [
        {
            description: "Pokédex régional de Johto dans Or HeartGold/Argent SoulSilver, mis à jour pour la 4ème génération",
            language: {
                name: "fr",
        ...
        {
            description: "HeartGold/SoulSilver Johto Dex — Dex aus Gold/Silber/Kristall um Fähigkeiten basierende Entwicklungen aus Generation IV erweitert",
            language: {
                name: "de",
